...
const getRandomMarks = (pairsAndThemes, randomMarks) => {
    const pairsAndRandomMarks = Math.floor(Math.random() * 5) + 1;
    const studentsMarks = [];
...
const resultOfGettingTogether = getRandomMarks(pairsAndThemes,randommarks);
